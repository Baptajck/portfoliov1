...
const Presentation = () => {
  const scrollToGamebook = () => {
    window.scrollTo(2071.199951171875, 2071.199951171875);
  };
  const scrollToLikemovie = () => {
    window.scrollTo(2476, 2476);
  };
  return (
    <div className="presentation">
      ...
      <div className="presentation-header">
        <p className="presentation-desc">
          Je m'appelle Baptiste Parville et ma passion pour le développement web commence un peu par hasard après quelques cours pris sur OpenClassrooms. Fort de cette découverte, je décide de changer de cap et de me lancer pleinement dans le développement web. Après 4 mois de formation intensive chez O'Clock, qui m'ont conforté dans mon idée, je me lance avec 3 de mes collègues dans un projet se voulant novateur et inédit : <span className="underline" onClick={scrollToGamebook}>GameBook</span>.
          A la fin de la formation, j'ai souhaité mettre mes compétences fraîchement acquises en action et c'est ainsi qu'est né : <span className="underline" onClick={scrollToLikemovie}>LikeMovie</span>.
